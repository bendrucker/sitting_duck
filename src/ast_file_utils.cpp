...
vector<string> ASTFileUtils::ProcessSinglePath(ClientContext &context, const string &path,
                                               const vector<string> &supported_extensions, bool ignore_errors) {
...
vector<string> ASTFileUtils::GetFiles(ClientContext &context, const vector<string> &patterns, bool ignore_errors,
                                      const vector<string> &supported_extensions) {
